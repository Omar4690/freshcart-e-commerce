  ...
  <div className="container mx-auto px-4">
    ...
    <div className="grid lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2">
        {/* Cart Items List */}
        <div className="space-y-4">{products.map((product)=> <CartItem key={product._id} info={product}/> )}</div>
      ...
      <div className="lg:col-span-1">
        <CartSummery totalCartPrice={totalCartPrice} numOfCartItems={numOfCartItems}/>
      </div>
    </div>
  </div>
</div>
