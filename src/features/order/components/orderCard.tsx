...
export default function orderCard({orderInfo}:{orderInfo: Order}) {
  ...
  return (
    <>
      <div
        className={`bg-white rounded-2xl border transition-all duration-300 overflow-hidden border-gray-100 shadow-sm hover:shadow-md`}
      >
        {/* Main Content */}
        <div className="p-5 sm:p-6">
          <div className="flex gap-5">
            ...
            <div className="relative shrink-0">
              <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl bg-linear-to-br from-gray-50 to-white border border-gray-100">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-start justify-between gap-3 mb-3">
                <div>
                  <div
                    className={`inline-flex items-center gap-1.5 px-2.5 py-1 ${status.colors.background} rounded-lg mb-2`}
                  >
                    <FontAwesomeIcon
                      icon={status.icon}
              ...
              <div className="flex items-center justify-between gap-4">
                ...
                <button
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm ${isExpanded ? 'bg-primary-600 text-white':'bg-gray-100 hover:bg-gray-200'} font-semibold transition-all `}
                  onClick={()=>{
       ...
       {/* Products List (Expandable) */}
        {isExpanded && (
          <>
            <div className="p-5 sm:p-6 border-t border-gray-50">
              ...
              <div className="p-4 rounded-xl bg-blue-50/50 border border-blue-100">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between text-gray-600">
                    <span>Shipping</span>
                    <span className="font-medium">
                      {orderInfo.shippingPrice === 0 ? "Free" : `${orderInfo.shippingPrice} EGP`}
                    </span>
                  </div>
